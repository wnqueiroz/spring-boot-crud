package com.wnqueiroz.crud.api.controllers;
...
import com.wnqueiroz.crud.api.responses.Response;
import com.wnqueiroz.crud.api.services.ClienteService;
...
public class ClienteController {
	...
	public ResponseEntity<Response<Cliente>> cadastrar(@Valid @RequestBody Cliente cliente,
		...
		if (resultValidation.hasErrors()) {
			...
			resultValidation.getAllErrors().forEach(erro -> erros.add(erro.getDefaultMessage()));
	...
	public ResponseEntity<Response<Cliente>> atualizar(@PathVariable(name = "id") String id,
			@Valid @RequestBody Cliente cliente, BindingResult resultValidation) {
